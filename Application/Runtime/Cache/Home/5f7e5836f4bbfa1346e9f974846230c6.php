...
<script language="javascript" type="text/javascript">
	...
	<div id="main">
		<div class="fjx"></div>
		<div class="go_story"><a href="javascript:history.go(-1);"><span>←</span>BACK</div></a>
		<div class="nr">
			<?php if($signed == 0): ?><div class="nrt">
					<img src="../../<?php echo ($images["img"]); ?>" />
				</div>
			<?php else: ?>
				<video autoplay="autoplay" preload="auto" controls="controls" src="../../<?php echo ($images["img"]); ?>"  width="100%"></video><?php endif; ?>
			<div class="nrbt"><?php echo ($images["name"]); ?></div>
		</div>
	</div>
	<div id="footer">
